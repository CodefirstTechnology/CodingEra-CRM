export const environment = {
   ...
   */
  /** Short interval for local testing (see production `environment.ts` for 4 minutes). */
  indiamartAutoSimulateIntervalMs: 60000,
  /**
   ...
   */
  indiamartAutoSimulateDurationMs: 1800000,
  useMockData: true,
  apiUrl: '/api',
